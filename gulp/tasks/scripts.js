...
gulp.task('scripts:3DTeam', function () {
  scripts(
    './app/src/js/main3DTeam.js',
    './app/dist/js/3D/mainTeam.js',
    'Scripts 3D Team'
  );
});
...
gulp.task('scripts', ['scripts:2D', 'scripts:3D','scripts:3DEvents','scripts:3DTeam']);
